...
#%%
#Wandb stuff
wandb.init(project="CNN_Baseline",notes="Test of skip connection")
config=wandb.config
config.y_plus=15
...
model=models.baseline_cnn_skip1(activation)
...
model.save(os.path.join("/home/au569913/DataHandling/models/trained",'baseline_skip_elu'))
