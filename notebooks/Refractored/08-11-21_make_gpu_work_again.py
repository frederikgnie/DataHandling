...
model=models.baseline_cnn_dropout(var,activation)
...
#%%
#Wandb stuff
# wandb.init(project="Thesis",notes="Test of dropout")
# config=wandb.config
...
model.fit(x=train,epochs=100000,validation_data=validation)
